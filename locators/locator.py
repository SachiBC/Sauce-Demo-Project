...
class FooterPageLocators:
    ...
    HAMBURGER_ICON = (By.ID, "react-burger-menu-btn")
    SIDEBAR_1 = (By.ID, "inventory_sidebar_link")
    SIDEBAR_2 = (By.ID, "about_sidebar_link")
    SIDEBAR_3 = (By.ID, "logout_sidebar_link")
    SIDEBAR_4 = (By.ID, "reset_sidebar_link")
